...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center main">
        <a href="" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#orangeModalSubscription" aria-pressed="true">ToDo List</a>
      </div>
        ...
        <div class="modal-dialog">
            <form action='todo.php' method='POST' class="modal-content">
