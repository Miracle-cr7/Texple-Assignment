...
<head>
    ...
    <link rel="stylesheet"
        href="https://mdbootstrap.com/wp-content/themes/mdbootstrap4/css/compiled-4.17.0.min.css?ver=4.17.0">
...
<body>
        ...
        <form method="GET" action="" class='pads'>
            <div class="row">
                <div class="col-sm-8 col-md-6 input-group" style="padding: 40px 0;">
                    <input type="text" name="word" class="form-control" id="search"
                        style="border-radius: 20px 0 0 20px; border-left: none;" placeholder="Try another word" />
    ...
    <div class="text-center main">
        <a href="" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#orangeModalSubscription"
            aria-pressed="true">ToDo List</a>
    </div>

    <div class="modal" id="orangeModalSubscription" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action='new.php' method='POST' class="modal-content">
